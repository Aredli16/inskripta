...
const stepRoutes = ["/register", "/register/lessons"];

const RegistrationStepsLayout = () => {
  ...
  const steps = [
    {
      id: "01",
      name: "Inscription de l'élève",
      description:
        "Compléter le formulaire d'inscription avec les informations de l'élève",
      path: "/register",
    },
    {
      id: "02",
      name: "Choix des cours",
      description: "Veuillez choisir les cours que vous souhaitez suivre",
      path: "/register/lessons",
    },
  ].map((step, index) => {
    const href = searchParams.has("registration")
      ? `${step.path}?registration=${searchParams.get("registration")}`
      : "#";
...
export default RegistrationStepsLayout;
